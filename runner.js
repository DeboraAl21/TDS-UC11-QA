...
// 2. Criar loop que execulta um teste para CADA caso da matriz
...
test('deve aplciar 10% de desconto corretamente para todos os cenários aleatórios ', () => {
    ...
    for( let i = 0; i < NUMERO_DE_TESTE; i++ ){
        ...
        const totalBrutoArredondado = Math.round(totalBruto * 100) / 100;
        ...
        test(`Cenário: ${i+1} | Total: ${totalBrutoArredondado} | Total com desconto: ${totalRecebido}`, () =>{
            expect(totalRecebido).toBe(totalEsperado);
        });
